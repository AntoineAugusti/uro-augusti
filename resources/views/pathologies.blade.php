...
@section('content')
    <h2 class="margin-bottom-30">Pathologies prise en charge</h2>
    <div class="row">
      <div class="col-md-4">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <p>
          Les urologues travaillent en équipe (gynécologues, kinésithérapeutes, diététiciennes) et peuvent ainsi prendre en charge les problèmes urinaires féminins.<br>
          Ils ont accès aux explorations urodynamiques et radiologiques si besoin.
        </p>
      </div>
    </div>
@stop
