...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-vertical-center">
            ...
            <p>Le numéro <abbr title="Répertoire Partagé des Professionnels de Santé">RPPS</abbr> du Dr Michel Augusti est le 10001914158.</p>
            <ul>
                <li><b>Discipline exercée :</b> chirurgie urologique</li>
                <li><b>Disciplines complémentaires d'exercice :</b><br>cancérologie : option chirurgie cancérologique<br>cancérologie : option traitements médicaux des cancers</li>
            </ul>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>Le Docteur Michel Augusti consulte à la clinique de la Côte d'Albâtre (anciennement Clinique Mégival), située en périphérie de la ville de Dieppe. La prise de rendez-vous se fait auprès de Roselyne, secrétaire dédiée à l'urologie ou <a href="{{ config('app.doctolib_url') }}" title="Rendez-vous sur Doctolib"> en ligne sur Doctolib</a>.</p>
