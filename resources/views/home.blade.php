...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>Le Docteur Michel Augusti consulte à la clinique de la Côte d'Albâtre, située en périphérie de la ville de Dieppe. La prise de rendez-vous se fait auprès de Roselyne, secrétaire dédiée à l'urologie ou <a href="{{ config('app.doctolib_url') }}" title="Rendez-vous sur Doctolib"> en ligne sur Doctolib</a>.</p>
